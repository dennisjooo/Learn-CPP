...
int main()
{
    ...
    // Early Binding (the function is chosen at compile-time, basically direct function call)
    switch (op)
    {
        case 0: std::cout << "The answer is: " << add(x, y) << '\n'; break;
        case 1: std::cout << "The answer is: " << subtract(x, y) << '\n'; break;
        case 2: std::cout << "The answer is: " << multiply(x, y) << '\n'; break;
    }


    // Late Binding (the function is not chosen until runtime)
